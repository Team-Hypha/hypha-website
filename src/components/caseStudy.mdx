...
3. <p class="cite-note" id="cite-note-ted-young-blog">
     Ted Young, <a href="">"Getting Started with OpenTelemetry for
     Go"](https://thenewstack.io/opentelemetry-in-go-its-all-about-context/)
   </p>
4. <p id="cite-note-">Distributed Tracing In Practice, page 237</p>
5. [ST] Jamie Riedesel in her book _Software Telemetry_
6. [LS](https://opentelemetry.lightstep.com/core-concepts/context-propagation/)

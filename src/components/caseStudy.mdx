...
<img src="/hypha/trace-and-logs.png" caption="Hypha UI connects logs and traces using Grafana" />
...
<img src="/storyline/lots_of_logs.png" />
...
<img src="/pipeline/Hypha-Pipeline-Emit.jpg" />
...
<img src="/pipeline/Hypha-Pipeline-Ship.jpg" />
...
<img src="/pipeline/Hypha-Pipeline-Present.jpg" />
...
<img src="/solutions/comparison-table.png" />
...
<img src="/solutions/comparison-table-with-hypha.png" />
...
<img src="/hypha/errors-dashboard.png" />
...
<img src="/observability/opentelemetry-horizontal-color.png" />
...
<img src="/architecture/Hypha-Instrumentation-Correlation.jpg" />
...
<img src="/architecture/Hypha-Instrumentation-After.jpg" />
...
<img src="/architecture/Hypha-Collect.jpg" />
...
<img src="/architecture/Hypha-Store.jpg" />
...
<img src="/architecture/Hypha-Present.jpg" />
...
### 9.1 Correlating Logs With Traces
...
<img src="/architecture/Log-and-Span-Instrumentation.jpg" />
...
<img src="/code/log-before-injection.png" />

Would look something like this after trace context is injected:

<img src="/code/log-after-injection.png" />
...
### 9.2 Deploying to ECS & Configuring For Production
...
<img src="/architecture/Hypha-Ship-Scalable.jpg" />
...
<img src="/architecture/Hypha-Architecture-Fargate.jpg" />
...
### 10.1 Deploying the Hypha Backend
...
<img src="/code/get-endpoints.png" />

### 10.2 Setup Instrumentation & Agent
...
<img src="/code/download-tracing.png" />

Install dependencies for OpenTelemetry instrumentation:

<img src="/code/install-instrumentation-libraries.png" />

Then restart your Node application to include the instrumentation:

<img src="/code/restart-application.png" />

##### Set up Hypha Agent

Download the install script:

<img src="/code/download-agent-install.png" />

<img src="/code/install-and-start-agent.png" />

...
To deploy Hypha’s backend locally or directly on a VPS, clone the Hypha Backend <a href="https://github.com/Team-Hypha/hypha-backend">repository</a>, and run `docker compose -f local-compose.yml up`.
